...
${Prestation1}    COPRECGC
${Prestation2}    Allongement de la durée des traveaux
...
BV_23579
    ...
    Sleep               5
    Modification Devis ligne COPRECGC avec prix 300
    Sleep       4
...
#     Je clique sur //div[p[contains(text(), 'Opportunité')]]//a
#     Sleep    5
#     Je clique sur (//button[@class='slds-button slds-button_brand'])[2]
#     Sleep      2
# ######################################################################################################
