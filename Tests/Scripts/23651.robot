...
BV_23651
    ...
    Sleep    2
    Je clique sur iframe[name="${iframe}"] >>> "Missions" >> nth=0
    ...
    Sleep          1
    Je clique sur iframe[name="${iframe}"] >>> paper-checkbox:left-of(:text("SH")) >> nth=0  
 
    Sleep     2
    Je clique sur iframe[name="${iframe}"] >>> "Missions Connexes" >> nth=0
    Je clique sur iframe[name="${iframe}"] >>> paper-checkbox:left-of(:text("CC-BIMBA")) >> nth=0  
    ...
    Sleep    2
    Je clique sur iframe[name="${iframe}"] >>> "Extensions" >> nth=0
    # Je clique sur iframe[name="${iframe}"] >>> paper-checkbox:left-of(:text("Installations électriques des immeubles d’habitation en phase de réalisation ")) >> nth=0  
    Sleep     2
    Je clique sur iframe[name="${iframe}"] >>> "Enregistrer" >> nth=0
    Sleep     5
 
    Modification Devis ligne CC-BIM 1 avec prix 100
    Modification Devis ligne Allongement de la durée des travaux avec prix 200
    # Modification Devis ligne Installations électriques des immeubles d’habitation en phase de réalisation avec prix 100
    Modification Devis ligne COPRECBA avec prix 300
    Sleep     3
